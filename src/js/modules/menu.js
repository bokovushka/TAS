...
setInterval(function () {
	if ($(".header-top").hasClass("header--hide")) {
		$(".header-top .header-top--languages .current-lang").removeClass("active");
		$(".header-top .header-top--languages .current-lang--inner").removeClass("active");
		$(".header-top .header-top--languages .current-lang .submenu").removeClass("active");
	}
}, 1000);
